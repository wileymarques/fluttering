...
(function dartProgram() {
  ...
  E = {
    main($arguments) {
      H.printString(C.JSInt_methods.toString$0(new E.Person().super$P3$teste()));
    },
    ...
    _Person_P2_P3: function _Person_P2_P3() {
    }
  },
  ...
  E._Person_P2_P3.prototype = {};
  (function aliases() {
    var _ = E.P3.prototype;
    _.super$P3$teste = _.teste$0;
  })();
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, H.Closure, H.Rti, H._FunctionParameters, P.Null, P.StringBuffer, E.P2, E.P3]);
    ...
    _inherit(E._Person_P2_P3, E.P2);
    _inherit(E.Person, E._Person_P2_P3);
    _mixin(E._Person_P2_P3, E.P3);
  })();
  var init = {
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JSBool":{"bool":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSInt":{"int":[]},"JSString":{"String":[]}}'));
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return E.main(H.convertMainArgumentList(args));
    };
